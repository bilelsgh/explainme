...
if "client" not in st.session_state or st.session_state.client_choice != client_choice:
    prompt_instr = """
            ...
            Your task is to generate a Python script using the Manim library to visually illustrate the concept. Follow these strict rules to ensure clarity and readability:

            1. Clarity & Spacing
            No Overlapping: Objects and text must never overlap.
            No Off-Screen Elements: Ensure that all text and objects remain within the video frame (16:9 aspect ratio).
...
if st.button("Explain me!", disabled=not (topic and concept_name and description)):
